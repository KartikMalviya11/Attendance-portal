                ...
                <div class="table-responsive">
                  <!-- Projects table -->
                    ...
                    <tbody id="attendance_data_tbody">
                        @if (Session::get("attendancePending"))
                        @foreach (Session::get("attendancePending") as $item)
                        <tr>
                            <td>{{$item->name}} </td>
                            <td>{{$item->in_time}} </td>
                            <td>{{$item->out_time}} </td>
                            ...
                            <td> <a href="/approve/eod/{{$item->id}}" class="  btn btn-success" >
                                {{$item->attendance_status == 1 ? "Marked" : "Mark"}}
                            </a></td>
                        </tr>
                        @endforeach
                        @else
