...
<head>
  ...
  <title>Hashstar | @yield("title") </title>
  <!-- Favicon -->
  <link rel="icon" href="/images/hashstar/favicon.png" type="image/png">
  <!-- Fonts -->
    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
            <img src="/images/hashstar/Text-Violet.png" class="navbar-brand-img"style="transform:scale(1.8)">
          </a>
      </div>
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/pending/leaves">
                <i class="ni ni-circle-08 text-pink"></i>
                <span class="nav-link-text">Employee Pending Leaves</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/employee/details">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">{{Session::get("hr")['name']}}</span>
                  </div>
                </div>
              </a>
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <a href="/hr/logout" class="dropdown-item">
