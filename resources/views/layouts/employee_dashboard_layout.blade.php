...
<head>
  ...
  <title>HashStar | Employee Manager</title>
  <!-- Favicon -->
    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="/images/hashstar/Text-Violet.png" class="navbar-brand-img"style="transform:scale(1.2)">
        </a>
      </div>
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/my/leave/status">
                  <i class="ni ni-bullet-list-67 text-default"></i>
                  <span class="nav-link-text">Applied Leave Status</span>
                </a>
              </li>
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                      ...
                      <span class="mb-0 text-sm  font-weight-bold">{{Session::get('employee')['name']}}</span>
                      @endif
                  </div>
                </div>
              </a>
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <a href="/logout/employee" data-sid="{{Session::get('employee')['id']}}"   class="dropdown-item">
